    ...
    <>
      ...
      >
        ...
        <CustomContainer>
          ...
          {onboardingStep == 2 && (
            <WhatAreYouHereFor setConversationType={setConversationType} />
          )}
...
const WhatAreYouHereFor = (props) => {
  return (
    <Container
      ...
      marginBottom={'20px'}
    >
      <Heading lineHeight={1.5} fontSize={{ base: '1xl' }}>
  ...
  return (
    ...
    >
      ...
      <HStack>
        ...
        <BaseCard
          image={
            'https://em-content.zobj.net/socialmedia/apple/81/shrug_1f937.png'
          }
          action={() => props.setVoice('female')}
